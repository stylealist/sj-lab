...
플랫폼의 모든 웹 서비스는 서브도메인 기반 HTTPS 환경으로 구성되어 운영 중입니다.
...
| **서비스 레지스트리 (sj-lab-discoveryServer)**| [https://eureka.sj-lab.co.kr](https://eureka.sj-lab.co.kr) | Eureka 마이크로서비스 인스턴스 등록 현황 모니터링 대시보드 |
| **모바일 동기화 클라우드 (QFieldCloud)** | [https://qfield.sj-lab.co.kr](https://qfield.sj-lab.co.kr) | 현장조사 모바일 앱 데이터 패키징 및 원격 동기화 서버 |
